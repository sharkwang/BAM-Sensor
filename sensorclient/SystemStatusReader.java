...
public class SystemStatusReader
{
    ...
    public static Double cpuUsage (int measureMode) throws Exception {
	    ...
	    // System.out.println(mpstatLine);
            ...
            if (mpstatLine == null) {
                ...
                selected_idle = Double.parseDouble(mpstatChunkedLine[9]);
            } else {
	...
	System.out.println("CPU Usage:" + new DecimalFormat("0.00").format(cpuUsage(AVERAGE)) + "%");
    }
}
